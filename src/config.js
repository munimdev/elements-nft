...
export const NFTABI = [
  ...
  {
    inputs: [],
    name: "getEligibleTokenCountTotal",
    outputs: [
      {
        internalType: "uint256[4]",
        name: "",
...
export const oracleContract = new web3.eth.Contract(oracleABI, oracleAddress);
